...
#define WPOPENV_ERROR   "(1975): An error ocurred while calling wpopenv(), NULL was returned."
#define SNPRINTF_ERROR  "(1976): An error ocurred while calling snprintf(). Return value: %d."
