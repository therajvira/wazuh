...
int FIMDB::insertItem(std::unique_ptr<DBItem> const item)
{
    try
    {
...
int FIMDB::removeItem(std::unique_ptr<DBItem> const item)
{
    try
    {
...
int FIMDB::updateItem(std::unique_ptr<DBItem> const item, ResultCallbackData callbackData)
{
    try
    {
